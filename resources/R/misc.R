...
#' @param bias_correct  Logical; apply a small-sample bias correction to the
#'                  lag-1 autocorrelation estimates (default TRUE). Helps because
#'                  the sample lag-1 ACF is biased low in short series, which
#'                  otherwise makes N_eff optimistically large.
#'
